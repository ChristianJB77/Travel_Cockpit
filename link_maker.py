...
def links(dest, loc_classes, switch):
    ...
    if switch == "German" or loc_classes['language'] == 'german':
        ...
        if loc_classes['loc_type'] == 'country':
            links_dic['maps'] = "https://www.google.com/maps/embed/v1/search?key= \
                                AIzaSyBxDSAZmHZeS8rJXJ1e4_G3VO-BQD4Okn0&q=" \
                                + country_de + "/&language=de"
        #Big City
        elif loc_classes['loc_type'] == 'big_city':
            links_dic['maps'] = "https://www.google.com/maps/embed/v1/search?key= \
                                AIzaSyBxDSAZmHZeS8rJXJ1e4_G3VO-BQD4Okn0&q=" \
                                + loc_classes["city"] + "/&language=de"
        #Good luck mode
        else:
            links_dic['maps'] = "https://www.google.com/maps/embed/v1/search?key= \
                                AIzaSyBxDSAZmHZeS8rJXJ1e4_G3VO-BQD4Okn0&q=" \
                                + loc_classes["location"] + "/&language=de"
    ...
    #English
        ...
        if loc_classes['loc_type'] == 'country':
            links_dic['maps'] = "https://www.google.com/maps/embed/v1/search?key= \
                                AIzaSyBxDSAZmHZeS8rJXJ1e4_G3VO-BQD4Okn0&q=" \
                                + country_en + "/&language=en"
        #Big City
        elif loc_classes['loc_type'] == 'big_city':
            links_dic['maps'] = "https://www.google.com/maps/embed/v1/search?key= \
                                AIzaSyBxDSAZmHZeS8rJXJ1e4_G3VO-BQD4Okn0&q=" \
                                + loc_classes["city"] + "/&language=en"
        #Good luck mode
        else:
            links_dic['maps'] = "https://www.google.com/maps/embed/v1/search?key= \
                                AIzaSyBxDSAZmHZeS8rJXJ1e4_G3VO-BQD4Okn0&q=" \
                                + loc_classes["location"] + "/&language=en"

    """Climate"""
    #German
    if loc_classes['language'] == "german" or switch == "German":
        #Available at reise-klima.de
        dest_up = dest.upper()
        if db.execute("SELECT * FROM reise_klima WHERE (UPPER(destination)=:dest_up \
                    OR LOWER(destination)=:dest)", dest_up=dest_up, dest=dest):
